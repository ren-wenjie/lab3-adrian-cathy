...
public class Person {
	...
	public Person(String name, String address, String city,  String postcode, Course myCourse) {
		this.name = name;
		this.address = address;
		this.city = city;
		this.postcode = postcode;
	...
	public Person(String name, String address, String city,  String postcode, String phone, Course myCourse) {
		this.name = name;
		this.address = address;
		this.city = city;
		this.postcode = postcode;
